 ...
 fs-2 text-info"></i>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                ...
                                <div class="menu-item px-5">
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        ...
                                        <x-dropdown-link :href="route('logout')" class="menu-link px-5" onclick="event.preventDefault();
                        ...
                        <div class="app-navbar-item ms-3 ms-lg-4 ms-n2 me-3 d-flex d-lg-none">
                            <div class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px"
                                ...
                                <i class="ki-duotone ki-burger-menu-2 fs-2"><span class="path1"></span><span
                                        class="path2"></span><span class="path3"></span><span class="path4"></span><span
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
    ...
    <div class="menu-sub menu-sub-accordion">
        <div class="menu-item">
            <a class="menu-link" href="bq-documents.html" title="Create, manage, and store BQ documents">
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
    ...
    <div class="menu-sub menu-sub-accordion">
        <div class="menu-item">
            <a class="menu-link" href="generate-bom.html" title="Generate BOM from BQ">
                <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
        ...
        <div class="menu-item">
            <a class="menu-link" href="messaging-system.html" title="Messaging system with notifications and alerts">
                ...
                <span class="menu-title">Messaging System</span>
                        ...
                        <div class="app-sidebar-project-default app-sidebar-project-minimize text-center min-h-lg-400px flex-column-auto d-flex flex-column justify-content-end"
                            ...
                            <!--begin::Illustration-->
                            <img class="mx-auto h-150px h-lg-175px mb-4"
                                src="{{ asset('assets') }}/media/misc/saul-welcome.png" alt="">
                            <!--end::Illustration-->
                ...
                <div id="kt_app_footer"
                    ...
                    <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
                        ...
                        <li class="menu-item"><a href="https://keenthemes.com/products/saul-html-pro" target="_blank"
            ...
            <div id="kt_app_aside" class="app-aside  flex-column " data-kt-drawer="true" data-kt-drawer-name="app-aside"
                ...
                <div id="kt_app_aside_wrapper"
                    class="d-flex flex-column align-items-center hover-scroll-y scroll-ms py-5 py-lg-0 gap-4"
                    ...
                    <a href="apps/calendar.html"
                        ...
                        <i class="ki-duotone ki-calendar-add fs-2qx"><span class="path1"></span><span
                                class="path2"></span><span class="path3"></span><span class="path4"></span><span
                                class="path5"></span><span class="path6"></span></i> </a>
                    <a href="account/overview.html"
                        ...
                        <i class="ki-duotone ki-message-add fs-2qx"><span class="path1"></span><span
    ...
    <div id="kt_app_layout_builder" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="app-settings"
        ...
        <div class="card border-0 shadow-none rounded-0 w-100">
            ...
            <div class="card-header bgi-position-y-bottom bgi-position-x-end bgi-size-cover bgi-no-repeat rounded-0 border-0 py-4"
                ...
                style="background-image:url('{{ asset('assets') }}/media/misc/layout/customizer-header-bg.jpg')">

                <!--begin::Card title-->
                <h3 class="card-title fs-3 fw-bold text-white flex-column m-0">
                    Saul HTML Pro Builder
            ...
            <div class="card-body position-relative" id="kt_app_layout_builder_body">
                ...
                <div id="kt_app_settings_content" class="position-relative scroll-y me-n5 pe-5" data-kt-scroll="true"
                    ...
                    <!--begin::Form-->
                    <form class="form" method="POST" id="kt_app_layout_builder_form" action="/saul-html-pro/index.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="fw-semibold text-muted fs-7 d-block lh-1">
                                        ...
                                        <a class="fw-semibold"
                                            href="https://preview.keenthemes.com/html/saul-html-pro/docs/getting-started/dark-mode"
                            ...
                            <div class="form-group d-flex flex-stack">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="fs-7 fw-semibold text-muted">
                                        ...
                                        <a class="fw-semibold"
                                            href="https://preview.keenthemes.com/html/saul-html-pro/docs/getting-started/rtl"
                                            target="_blank">See docs</a>
                                    </div>
                                </div>
                                <!--end::Heading-->
                            ...
                            <div class="form-group ">
                                ...
                                <div class="d-flex flex-column mb-4">
                                    ...
                                    <div>
                                        ...
                                        <a class="fw-semibold"
                                            href="https://preview.keenthemes.com/html/saul-html-pro/docs/icons/keenicons"
    ...
    <button id="kt_app_layout_builder_toggle" class="btn btn-dark app-layout-builder-toggle lh-1 py-4 "
        title="Saul HTML Pro Builder" data-bs-custom-class="tooltip-inverse" data-bs-toggle="tooltip"
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="/saul-html-pro/apps/projects/project.html" class="w-30px me-3"
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                        src="{{ asset('assets') }}/media/avatars/300-25.jpg"></div><!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                    ...
                    <div class="d-flex justify-content-end mb-10 ">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Avatar-->
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                        src="{{ asset('assets') }}/media/avatars/300-1.jpg"></div><!--end::Avatar-->
                            </div>
                            <!--end::User-->
                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true"
                    ...
                    <div class="rounded border border-dashed border-gray-300 py-6 px-8 mb-5">
                        ...
                        <div class="d-flex flex-column flex-center mb-3">
                            ...
                            <div class="mb-2">
                                <img src="{{ asset('assets') }}/media/svg/payment-methods/paypal.svg" alt=""
                                    class="h-30px me-3 rounded-1">

                                <img src="{{ asset('assets') }}/media/svg/payment-methods/visa.svg" alt=""
                                    class="h-30px me-3 rounded-1">

                                <img src="{{ asset('assets') }}/media/svg/payment-methods/mastercard.svg" alt=""
                                    class="h-30px me-3 rounded-1">

                                <img src="{{ asset('assets') }}/media/svg/payment-methods/americanexpress.svg" alt=""
        ...
        <div class="card shadow-none rounded-0 w-100">
            ...
            <div class="card-body" id="kt_help_body">
                ...
                <div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true"
                    ...
                    <!--begin::Link-->
                    <a href="https://preview.keenthemes.com/html/saul-html-pro/docs"
                    ...
                    <!--end::Link-->
                    <!--begin::Link-->
                    <a href="https://preview.keenthemes.com/html/saul-html-pro/docs/base/utilities"
                        class="parent-hover d-flex align-items-center mb-7">
                        <!--begin::Icon-->
                        <div
                    ...
                    <!--end::Link-->
                    <!--begin::Link-->
                    <a href="https://preview.keenthemes.com/html/saul-html-pro/docs/getting-started/changelog"
                        class="parent-hover d-flex align-items-center mb-7">
                        <!--begin::Icon-->
                        <div
    ...
    <div
        ...
        <button id="kt_explore_toggle" class="engage-explore-toggle engage-btn btn shadow-sm fs-6 px-4 rounded-top-0"
            title="Explore Saul HTML Pro" data-bs-custom-class="tooltip-inverse" data-bs-toggle="tooltip"
            data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover">
    ...
    <!--end::Modal - Upgrade plan--><!--begin::Modal - Create account-->
    ...
    <!--end::Modal - Create project--><!--begin::Modal - Create App-->
